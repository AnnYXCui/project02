...
$('#chtAnimatedBarChart').animatedBarChart({
  ...
  bars: {
    ...
    hover_name_text: 'kind', // text for name column for label displayed on bar hover
  ...
  //legend
    legend: {
      ...
      width: 600 // legend width in pixels for left/right
    },
