...
$('#quiz').quiz({
  ...
  questions: [
    {
      'q': 'Juan was very drowsy, though not quite asleep. What EEG pattern was Juan likely exhibiting?',
      'options': [
        'A. beta waves',
        'B. alpha waves',
        'C. theta waves',
      ...
      'correctIndex':1,
      'correctResponse': 'Yes, you are correct!',
      'incorrectResponse': 'Sorry, that is not the correct answer.'
    },
    {
      'q': 'When we sleep late into the day and wake up much later than is usual (e.g., 2 PM), which of the following is true?',
      'options': [
        'A. We feel very alert because we are waking up during a time when Beta waves are predominant. ',
        'B. We feel sluggish and "out of sync" because our sleep rhythm is out of synchrony with other circadian rhythms.',
        'C. We feel very alert because we have allowed our body to sleep as much as it needed.',
        'D. We feel sluggish and "out of sync" because we are waking up during a time when Delta waves are predominant.'
    ...
    {
      'q': 'Which of the following is MOST true about sleep?',
      'options': [
        'A. It is a state when our entire brain is inactive.',
        'B. Elderly people sleep more than younger people.',
        'C. For human sleep, there are five stages and we cycle through these cycles approximately 4-5 times per night.',
        'D. Stage 4 sleep is predominated by sleep spindles and theta waves.'
      ],
      'correctIndex': 2,
      'correctResponse': 'Yes, you are correct!',
      'incorrectResponse': 'Sorry, that is not the correct answer.'
